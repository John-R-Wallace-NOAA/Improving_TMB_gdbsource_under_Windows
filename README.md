...
in the 'R_and_CPP' folder (in this repo) gives information how to download and install GDB version 8.5.0 from winlibs.com. GCC 10.3.0 also contains GDB version 8.5.0. Also, the more recent GCC versions do contain later versions of GDB, but they are more complexly integrated into the release. 
