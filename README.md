...
in the 'R_and_CPP' folder (in this repo) gives information how to download and install GDB version 8.5.0 from winlibs.com. GCC 10.3.0 also contains GDB version 8.5.0. The more recent GCC versions to contain later versions of GDB, but they are more complexly intergrated into the release. This GDB ver 8.5.0 properly gives the backtrace with line number information when using the compile options given in the help for TMB::gdbsource().
