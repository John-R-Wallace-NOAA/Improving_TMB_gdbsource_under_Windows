...
rem gdb.exe and its supporting files will be installed into C:\rtools42\x86_64-w64-mingw32.static.posix\bin
rem If you get a "Publisher Could Not Be Verified" message, follow the instructions here: https://www.technipages.com/disable-publisher-could-not-be-verified-messages

robocopy . C:\rtools42\x86_64-w64-mingw32.static.posix\bin gdb.exe libboost_regex-mt-x64.dll libdl.dll libexpat-1.dll libgcc_s_seh-1.dll libgmp-10.dll libiconv-2.dll liblzma-5.dll libmpfr-6.dll libncurses6.dll libncursesw6.dll libreadline8.dll libsource-highlight-4.dll libstdc++-6.dll libwinpthread-1.dll mman-win.dll xxhash.dll zlib1.dll 
